...
img1_color = cv2.imread("Input/img0.jpg")  # Image to be aligned.
img2_color = cv2.imread("Input/8T/ref.jpg")  # Reference image.
...
# Save the output.
cv2.imwrite('Output/SK/8T/output7.jpg', transformed_img)